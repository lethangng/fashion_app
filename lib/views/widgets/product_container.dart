...
class ProductContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Opacity(
      opacity: product.status == 1 ? 0.5 : 1,
      child: Column(
                      ...
                      Positioned(
                        ...
                        child: Row(
                          children: [
                            ...
                            Visibility(
                              visible: product.sell_off.isNotEmpty,
                              child: Container(
                                padding: const EdgeInsets.symmetric(
                                  horizontal: 5,
                                  vertical: 3,
                ...
                child: Positioned(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      alignment: Alignment.center,
                      decoration: BoxDecoration(
                        color: productType == ProductType.favarite
                            ? ColorApp.primary
                            : Colors.white,
                      ...
                      child: SvgPicture.asset(
                          'assets/icons/${(productType == ProductType.favarite) ? 'bar-2' : 'heart'}.svg'),
                    ),
                  ),
                ),
              ),
